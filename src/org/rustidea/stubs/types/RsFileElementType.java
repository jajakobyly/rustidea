...
public class RsFileElementType extends IStubFileElementType<RsFileStub> {
    public static final RsFileElementType INSTANCE = new RsFileElementType();

    public static final int VERSION = 0;

    private RsFileElementType() {
