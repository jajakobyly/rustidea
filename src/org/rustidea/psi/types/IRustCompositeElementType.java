...
public class IRustCompositeElementType extends IRustElementType implements ICompositeElementType {
    private final ConstructorAccessor constructor;

    public IRustCompositeElementType(final String debugName, @NotNull final Class<? extends ASTNode> psiImplCls) {
        super(debugName);
