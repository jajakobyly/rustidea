...
public class RsParserTest extends ParsingTestCase {
    ...
    public void testTypeParams0001() {
        doTest(true);
    }

    public void testTypeParams0002() {
        doTest(true);
    }

    public void testTypes0001() {
        doTest(true);
    }

    public void testTypes0002() {
        doTest(true);
    }
    ...
    public void testTypes0005() {
        doTest(true);
    }

    public void testTypes0006() {
        doTest(true);
    }

    public void testTypes0007() {
        doTest(true);
    }

    public void testTypes0008() {
        doTest(true);
    }
